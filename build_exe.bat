...
echo   Copying libraries/itcl/ (Itcl 3.4 from ActiveTcl-for-Windows) ...
if not exist "%BUILD_DIR%\libraries\itcl" mkdir "%BUILD_DIR%\libraries\itcl"
xcopy /y /q "%DEPS_DIR%\ActiveTcl-for-Windows-master\lib\teapot\package\win32-ix86\lib\Itcl3.4\*.*" "%BUILD_DIR%\libraries\itcl\" >nul 2>&1
